...
export class News extends Component {
  ...
  constructor(props){
    ...
    document.title=`NewSpeaker-${this.props.category}`
  }

  async updateNews(){
    const url=`https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=849f21d206d740cba44653968bc25396&page=${this.state.page}&pageSize=${this.props.pageSize}`;
